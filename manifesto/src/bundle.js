...
<span id='Select'>Roghnaigh</span> <span id='a team'>foireann</span>
`,
...
<span id='In English'>I mBearla</span>, <span id='it is that'>tá</span> <span id='the Irish'>an Gaeilge</span> <span id='utterly separated'>glanscartha</span> <span id='from'>ó</span> <span id='the meaning'>brí</span> <span id='a'>an Gaeilge</span>.

`,

//5
`
<span id='Leaves'>Fágann</span> <span id='English'>Bearla</span> <span id='us'>muid</span> <span id='discussing'>ag plé</span> <span id='the question'>ceist</span> <span id='of the tongue'>an teanga</span> <span id='as though'>amhlaidh is</span> <span id='that'>gur</span> <span id='an ornament'>ornáid</span> <span id='decorative'>maisaithe</span> <span id='cultural'>cultúrtha</span> <span id='the Irish language is'>í an Gaeilge</span>.
...
`
<span id='We are left'>Fágtar muid</span> <span id='speaking'>ag caint</span> <span id='in terms'>i dtearmaí</span> <span id='of the number of'>líonn</span> 'Irish Speakers'. <span id='It is seen'>Feictear</span> <span id='that there are not'>nach bhfuil</span> <span id='many'>múrán</span><span id='speaking it'> á labhairt</span>, <span id='and'>agus</span><span id='it is assumed'> glachtar leis</span> <span id='therefore'>mar sin <span id='not much would be lost'>nach chailfar murán</span> <span id='without her'>gan í.</span> 
...
//7
`
<span id='Because'>Toisc</span> <span id='it is possible'>gur feidir <span id='any'>aon</span> <span id='notion'>nóisean</span> <span id='to translate to English'>a aistrú go Bearla</span>,<span id="there isn't any need"> níl aon gá</span><span id='for Irish'> le Gaeilge</span>.<span id='In English'> I mBearla</span>,<span id='there is no need for'> níl aon gá le</span><span id='Éire'> Éire</span>, <span id='because'>mar</span> <span id='is enough'>is leoir</span> <span id='Ireland'>'Ireland'</span>.
...
<span id='Here'>Seo</span><span id='another powerful thing'> rud laidir eile</span>:

`,

//9
 `   
<span id='there is'>tá</span> <span id='a bit of Irish'>Gaeilge éigin</span> <span id='posessed by'>ag</span> <span id='every'>gach</span> <span id='English-speaker'>Bearl-cainteoir</span> <span id='in the country'>sa tír</span>.<span='It is not'> Ní</span> <span id='a subject'>ábhar <span id='of mockery'>fachnaoid</span> <span id='those'>iad</span> <span id='the'>na</span><span id='so-called few words'> cúpla focal. <span id='Seeds'>Síolta</span><span id='they are'> íad</span>. 
...
<span id='It is not'>Ní </span><span id='an absence'>easpa</span> <span id='of Irish'>Gaeilge</span> <span id='which'>is</span> <span id='is the cause'>cúis</span><span id='of our'> len ár</span> <span id='riddle'>dúcheist</span> <span id='language'>teanga</span>. <span id='Nor'>Ná</span> <span id='absence'>easpa</span><span id='interest'> spéis</span>, <span id='nor ability'>ná cumas</span>, <span id='nor'>ná</span> <span id='will'>thoill</span><span id='either'> ach oiread</span>.
...
//12
`
<span id='An absence'>Easpa</span> <span id='of room'>spás</span> <span id='is the cause'>is cúis</span><span id='of/with it'> leis</span>. <span id='There is no'>Níl</span> <span id='room'>spás</span> <span id='in'>sa</span> <span id='the imagination'>samhlíocht</span> <span id='English'>Bearla</span> <span id='for'>i gcomhair</span> <span id='thoughts'>smaointe</span><span id='Gaelic'> Gaelach</span>. 
...
//13
`
<span id='The aim'>Cuspoir</span> <span id='of this manifesto'>an forógra seo</span> <span id='is that'>ná</span> <span id='it would help'>go cuideoidh <span id='a virtual space'>spás fíorúil</span> <span id='with us'>linn</span> <span id='to exist as'>bheith</span><span id='Gaels'> Gaelach</span>. 

`,

//14
`<span id='Imagine'>Samhlaigh</span> <span id='a platform'>árdán</span> <span id='social'>socialta</span> <span id='multifunctional'>ilfeidhmnú</span> <span id='in which one could'>inar feidir</span>: 

<span id='Ourselves'>Muid fein <span id='identify'>a sainú</span> <span id='as'>mar</span> Gael, <span id='in a'>i</span> <span id='"land"'>"tír"</span> <span id='Gaelic'>Gaelach</span> <span id='digital'>digitach</span>
<span id='Resources'>Áisanna</span> <span id='Gaelic'>Gaelach</span> <span id='discover'>a</span> aimsú <span id='and'>agus</span> <span id='share'>a roinnt</share>.
